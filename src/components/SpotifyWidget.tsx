...
export default function SpotifyWidget() {
    ...
    return (
        <Link
            ...
            className="flex items-center gap-3 p-2 rounded-lg bg-secondary/30 hover:bg-secondary/50 border border-transparent hover:border-border transition-all group max-w-xs"
        >
            ...
            <div className="flex-1 min-w-0">
                <p className="text-xs font-semibold truncate group-hover:text-green-500 transition-colors">
                    {data.title}
                </p>
