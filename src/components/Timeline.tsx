                ...
                return (
                    ...
                    >
                        ...
                        <div className="w-[calc(100%-60px)] md:w-5/12 pl-4 md:pl-0 ml-12 md:ml-0">
                            <div className="relative p-6 bg-secondary/10 border border-secondary/20 rounded-2xl backdrop-blur-sm hover:border-primary/30 transition-colors group">
                                {/* Icon Badge */}
                                <div className={`absolute -top-4 ${isEven ? "md:-right-4 left-4 md:left-auto" : "md:-left-4 left-4"} w-8 h-8 rounded-lg ${item.type === 'experience' ? 'bg-blue-500/20 text-blue-400' : 'bg-green-500/20 text-green-400'} flex items-center justify-center border border-white/5`}>
