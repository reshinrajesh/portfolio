        ...
        <div className="min-h-screen bg-black text-white font-sans selection:bg-green-500/30">
            <div className="container mx-auto max-w-2xl px-6 py-24">
                ...
                >
                    ...
                    <p className="text-zinc-400">Archive of past incidents and maintenance events.</p>
                </motion.div>
                ...
                {isLoading ? (
                    ...
                    <div className="p-12 text-center border border-white/5 rounded-3xl bg-white/5">
                        ...
                        <p className="text-zinc-500 text-sm">Everything has been running smoothly.</p>
                    </div>
                ) : (
                    <div className="space-y-12">
                        {Object.entries(groupedIncidents).map(([month, monthIncidents], groupIndex) => (
                            ...
                            >
                                <h2 className="text-sm font-bold text-zinc-500 uppercase tracking-widest mb-6 sticky top-4 bg-black/80 backdrop-blur-md py-2 z-10">
                                    {month}
                                </h2>
                                    ...
                                    {monthIncidents.map((incident: any) => (
                                        <div key={incident.id} className="relative pl-8 border-l-2 border-white/10 group">
                                            ...
                                            <div className="mb-2">
                                                ...
                                                <p className="text-zinc-300 text-base leading-relaxed bg-white/5 p-4 rounded-2xl border border-white/5">
                                            ...
                                            {incident.updates && incident.updates.length > 0 && (
                                                <div className="mt-4 pl-4 border-l border-white/5 space-y-3">
                                                    {incident.updates.map((update: any) => (
                                                        <div key={update.id} className="text-sm text-zinc-400">
