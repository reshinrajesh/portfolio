...
export default function TravelLab() {
    ...
    return (
        <div className="relative h-full min-h-[300px] bg-[#0a0a0a] rounded-3xl border border-white/10 overflow-hidden flex flex-col">
            ...
            <div className="relative flex-1 w-full h-full mt-4">
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none opacity-20">
                    <path
                        d={`M${LOCATIONS[0].x * 10}% ${LOCATIONS[0].y * 10}% Q 50% 10% ${LOCATIONS[3].x * 10}% ${LOCATIONS[3].y * 10}%`}
                        fill="none"
                        stroke="orange"
                        strokeWidth="1"
                        strokeDasharray="5,5"
            ...
            <div className="p-6 border-t border-white/5 bg-white/5 backdrop-blur-sm">
                <div className="flex justify-between items-center text-xs text-white/40 font-mono">
                    <span>COORDS: 19.0760° N, 72.8777° E</span>
