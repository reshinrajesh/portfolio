    ...
    return (
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 selection:bg-white/30">
            <div className="max-w-2xl text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                <div className="w-20 h-20 bg-zinc-900 border border-white/10 rounded-3xl mx-auto flex items-center justify-center shadow-2xl relative overflow-hidden">
                    ...
                    <svg
                        ...
                        className="text-zinc-400 relative z-10"
                    >
                        <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
                    </svg>
                </div>

                <h1 className="text-4xl md:text-5xl font-black tracking-tighter bg-clip-text text-transparent bg-gradient-to-br from-white to-zinc-500">
                    We'll be right back.
                </h1>
                ...
                <div className="pt-8 flex items-center justify-center gap-3 text-sm text-zinc-500 font-mono">
